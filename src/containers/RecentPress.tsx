...
import catapult from "../icons/catapult.png"
  ...
  return (
    <Gradient>
      ...
      <LogoGroup>
        ...
        <a
          href="https://www.digicatapult.org.uk/news-and-insights/blog/surroundscapes-exploring-the-power-of-sound-in-vr-ar-immersive"
          target="_blank"
        >
          <WhiteRect>
            <Catapult src={catapult} alt="catapult" />
          </WhiteRect>
        </a>
      </LogoGroup>
    </Gradient>
